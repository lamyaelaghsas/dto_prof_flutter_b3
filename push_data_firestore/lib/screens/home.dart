...
class _HomeState extends State<Home> {
          ...
          children: <Widget>[
            ...
            FloatingActionButton.extended(
              onPressed: () async {
                await authenticate();
                await addUsers();
                await addCategoriesAndProducts();
              },
              label: const Row(
                children: [
  ...
  Future<void> deleteCollections() async {
    ...
    // Boucler sur les catégories pour récupérer les produits à l'intérieur
    // Supprimer les produits pour ensuite supprimer la catégorie
  ...
  Future<void> addCategoriesAndProducts() async {
    final db = FirestoreODM(appSchema, firestore: FirebaseFirestore.instance);
    }
  }
}
